...
open class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    open var titleFont = UIFont(name: "Futura-Medium", size: 18)
    open var titleTextColor = UIColor(red:77/255, green:77/255, blue:77/255, alpha:1.0)
    
    // MessageView
    open var messageView = UILabel()
    open var messageFont = UIFont(name: "Futura-Medium", size: 15)
    ...
    open var buttonFont: [DOAlertActionStyle : UIFont] = [
        .default : UIFont(name: "Futura-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16),
        .cancel  : UIFont(name: "Futura-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16),
        .destructive  : UIFont(name: "Futura-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16)
    ]
